...
const InventoryNavbar = ({ onMenuClick }) => {
  const routeProduct = '/appInventory/products?view';
  const routeSettings = '/inventory/settings?view';
  ...
  const menus = {
    ...
    operaciones: {
      ...
      productos: {
        width: 'w-48',
        items: [
          { href: `${routeProduct}=products`, label: 'Productos' },
          { href: `${routeProduct}=productsvariants`, label: 'Variantes de producto' },
